...
describe('AppComponent', () => {
  ...
  it('Corroborando que parametros acepten números', ()=>{
    ...
    expect(typeof numero1 === 'number' && typeof numero2 === 'number').toEqual(true);

    // expect(numero1 && numero2).toEqual(Number);
  })
  ...
  it('Corroborando variables para recibir datos i son numero o cadena', ()=>{
    ...
    // expect(restaM && sumaM&& multiM&& divdiM).toBe(String);
    expect(typeof restaM && typeof sumaM && typeof multiM && typeof divdiM).toEqual("string");
  });
